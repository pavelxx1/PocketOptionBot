...
FIRST_RUN = True
SUCCESS_RATE = 0.56  # Минимальный винрейт для разрешения торговли
...
def calculate_squeeze_momentum(data, bb_period=15, bb_mult=2.0, kc_period=15, kc_mult=1.5):
    ...
    momentum = (close[-1] - ((highest_high + lowest_low) / 2)) / (highest_high - lowest_low) * 100
...
def check_data():
    ...
    global FIRST_RUN, TRADING_ALLOWED, SIGNAL_THRESHOLD
    ...
    try:
        ...
        if need_optimization:
            ...
            if winrate >= SUCCESS_RATE and results['total'] >= MIN_TRADES_FOR_OPTIMIZATION:
        ...
        if signals and len(signals) > 0:
            ...
            # Используем оптимизированный порог силы сигнала
